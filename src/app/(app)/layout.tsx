...
import { BottomNavigation, FloatingScanButton } from '@/components/features/navigation';
...
export default function AppLayout({
  ...
  return (
    <SyncEngineProvider>
      ...
      {/* Floating scan button - above navigation, hidden on /scan pages */}
      <FloatingScanButton />
